...
//    private final JdbcUserDetailsManager detailsManager;
    ...
    public void uploadDocuments() {
        ...
        auditRecordRepository.save(AuditRecord.builder()
                ...
                .objectId(UUID.fromString("c32a1bdd-d6a4-4a09-8e7b-249d6c7fd673"))
                .type(AuditRecordType.DOCUMENT_CREATE)
                .userId(UUID.fromString("c90b9c9f-ca1a-4b7c-bc77-3557c908f8d7"))
                .userTitle("Енотина А. В.")
                .build());
        auditRecordRepository.save(AuditRecord.builder()
                .createDate(Instant.now())
                .objectId(UUID.fromString("c32a1bdd-d6a4-4a09-8e7b-249d6c7fd673"))
...
//        incomingDocument.setId(UUID.fromString("d595a410-52fc-4b87-af1f-0c73ed2e8924"));
        ...
        for (int i = 0; i < 100; i++) {
            ...
            switch (type) {
                case "Входящий":
                    d = new IncomingDocument();
                    break;
                case "Исходящий":
                    d = new OutgoingDocument();
                    break;
                case "Внутренний":
                    d = new InnerDocument();
                    break;
